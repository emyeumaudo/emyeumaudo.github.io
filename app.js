...
function renderLeftNews(data) {
  ...
  firstArticleElement[0].innerHTML = `
        <div class="posts">
        <a href="${data.url}"><p class="title" style ='color: white;'>${data.title}</p></a>
  ...
  firstArticleElement[0].innerHTML += `
    ...
    <a href="${data.url}">
        ...
        <div class="post-info hl-text">
            <a class="share" href="${data.url}"><i class="fas fa-thumbs-up">${data.score}</i></a>
        </div>
    </a>
</div>`;
}
...
function renderEditorPick1(data) {
  ...
  firstArticleElement[0].innerHTML += `<div class="thumb">
    <a href="${data.url}"><img src="https://thearabweekly.com/sites/default/files/styles/article_image_800x450_/public/2020-05/45-258-suez.jpg?itok=sU0Wso-C" alt=""></a>
</div>
<div class="posts">
    <p class="title">${data.title}</p>
    <p class="author">${data.by}</p>
...
function renderEditorPick2(data) {
  ...
  firstArticleElement[0].innerHTML += `<div class="thumb">
    <a href="${data.url}"><img src="./vendor/img/6.jpeg" alt=""></a>
</div>
<div class="posts">
    <p class="title">${data.title}</p>
    <p class="author">${data.by}</p>
...
function renderEditorPick3(data) {
  ...
  firstArticleElement[0].innerHTML += `<div class="thumb">
    <a href="${data.url}"><img src="https://thoughtbrick.com/wp-content/uploads/2019/12/Meet-people-where-theyre-at-everyday-life.jpg" alt=""></a>
</div>
<div class="posts">
    <p class="title">${data.title}</p>
    <p class="author">${data.by}</p>
